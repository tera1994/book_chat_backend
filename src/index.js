...
app.post("/book-chat-room", async (req, res) => {
  try {
    ...
    return res
      .status(400)
      .json({ message: "FAILURE : Create a book chat room." });
  }
...
app.get("/book-chat-room/:id", async (req, res) => {
  ...
  try {
    ...
    return res
      .status(400)
      .json({ message: "FAILURE : Get the book chat room." });
  }
  return res
    .status(200)
    .json({ message: "SUCCESS: Get the book chat room.", bookChatRoom: book });
});
...
app.delete("/book-chat-room/:id", async (req, res) => {
  try {
    ...
    return res
      .status(400)
      .json({ message: "FAILURE : Delete the book chat room." });
  }
  return res
    .status(200)
    .json({ message: "SUCCESS: Delete the book chat room." });
});
